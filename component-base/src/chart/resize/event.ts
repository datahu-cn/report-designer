...
var _w = window as any
let resetTriggers = _w.resetTriggers
let scrollListener = _w.scrollListener
...
if (!attachEvent) {
  ...
  var cancelFrame = (function () {
    var cancel =
      _w.cancelAnimationFrame ||
      _w.mozCancelAnimationFrame ||
      _w.webkitCancelAnimationFrame ||
      _w.clearTimeout
  ...
  var animation = false,
    ...
    pfx = ''
  {
    var elm: any = document.createElement('fakeelement')
...
let addResizeListener = function (element: any, fn: any) {
...
let removeResizeListener = function (element: any, fn: any) {
