...
export declare class ScatterChartComponentOption extends BaseComponentOption {
...
export declare class ScatterChartComponent extends Cartesian2dChartComponent {
    icon: string;
    constructor(language: string);
    title: string;
    option: ScatterChartComponentOption;
