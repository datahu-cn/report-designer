...
export declare class BarHorizontalChartComponentOption extends BaseComponentOption {
...
export declare class BarHorizontalChartComponent extends Cartesian2dChartComponent {
    icon: string;
